    ...
    public static class Cards
    {
        ...
        public static ThumbnailCard GetDatabaseThumbnailCard()
        {
            ...
            var heroCard = new ThumbnailCard
            {
                ...
                Images = new List<CardImage> { new CardImage($"https://mystorage891032.blob.core.windows.net/daneblob/ChevronLogo2.PNG") },

                Buttons = new List<CardAction>
                        {

                           new CardAction(ActionTypes.OpenUrl, "Create A Request", value: "https://go.chevron.com/dmirequest"),
        ...
        public static HeroCard GetHelpHeroCard()
        {
            ...
            var heroCard = new HeroCard
            {
                ...
                /// Images = new List<CardImage> { new CardImage($"https://mystorage891032.blob.core.windows.net/daneblob/SqlLogo.png") },
                Buttons = new List<CardAction>
                        {
                           new CardAction(ActionTypes.OpenUrl, title: "About me", value: "https://mystorage891032.blob.core.windows.net/daneblob/Ylena.html"),
        ...
        public static HeroCard GetSQLHeroCard()
        {
            ...
            var heroCard = new HeroCard
            {
                ...
                Images = new List<CardImage> { new CardImage($"https://danevirtualassistant.blob.core.windows.net/daneblob/SqlLogo.png") },
                Buttons = new List<CardAction>
                        {
        ...
        public static HeroCard GetOracleHeroCard()
        {
            ...
            var heroCard = new HeroCard
            {
                ...
                Images = new List<CardImage> { new CardImage($"https://danevirtualassistant.blob.core.windows.net/daneblob/OracleLogo.png") },
                Buttons = new List<CardAction>
                        {
        ...
        public static HeroCard GetPowerBIHeroCard()
        {
            ...
            var heroCard = new HeroCard
            {
                ...
                Images = new List<CardImage> { new CardImage($"https://danevirtualassistant.blob.core.windows.net/daneblob/PowerBILogo.png") },
                Buttons = new List<CardAction>
                        {
        ...
        public static HeroCard GetGeneralHeroCard()
        {
            var heroCard = new HeroCard
            {
                ...
                Images = new List<CardImage> { new CardImage($"https://danevirtualassistant.blob.core.windows.net/daneblob/ChevronLogo2.PNG") },
                Buttons = new List<CardAction>
                        {
        ...
        public static HeroCard GetDatabaseHeroCard()
        {
            ...
            var heroCard = new HeroCard
            {
                ...
                Images = new List<CardImage> { new CardImage($"https://mystorage891032.blob.core.windows.net/daneblob/bg.png") },
                Buttons = new List<CardAction>
                        {
                            ...
                            new CardAction(ActionTypes.OpenUrl, title: "Create a Request", value: "https://go.chevron.com/dmirequest"),
                            new CardAction(ActionTypes.ImBack, title: "Quit", value: "Quit"),
                        },
            };
        ...
        public static Attachment ByeGIF()
        {
            ...
            var attachment = new Attachment
            {
                ...
                ContentUrl = $"https://mystorage891032.blob.core.windows.net/daneblob/ChevronLogo2.PNG",
            };
        ...
        public static AnimationCard GetAnimationCard()
        {
            ...
            var animationCard = new AnimationCard
            {
                ...
                {
                    Url = "https://mystorage891032.blob.core.windows.net/daneblob/bg.jpg",
                },
